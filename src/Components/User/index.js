...
if(this.props.friends){
 return (
      <article className="Comments" ref="Comments">
		...
		<button class="btn btn-secondary" onClick={this.viewProfile}>View Profile</button>
	    </div>
          </div>
        </header>
 ...
 return (
      <article className="Comments" ref="Comments">
	    ...
	    <div className="Comment-meta">
		<button class="btn btn-secondary btn-sm" onClick={this.viewProfile}>View Profile</button>
	    </div>
          </div>
        </header>
        <div className="Comments-caption">
         	<div><h5>Send a friend request : </h5> <button class="btn btn-secondary btn-sm" onClick = {this.sendRequest}>Request</button></div>
        </div>
      </article>
    );
}
